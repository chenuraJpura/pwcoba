<?php include_once('inc/user_dt.php');
 ...
 <div class="page__container" >
    ...
    <article class="profile">
      <header class="profile__header">
        ...
        <img src="uploads/<?php echo $us_img ;?>" class="profile__avatar" alt="avatar of Stas Melnikov">
        <h3 class="profile__name" style="text-transform: capitalize"><?php echo $fn;?>&nbsp;<?php echo $ln;?> </h3>
        <span class="profile__post"><?php echo $em ;?></span>
      </header>
      <div class="profile__stats" >
        <div class="profile__group" style="
border-right: 3px solid #1E2833;">
          <span class="profile__value"><?php echo $age;?></span>
          <span class="profile__param"><span class="glyphicon glyphicon-text-background">&nbsp;</span>Age</span>
        </div>
        <div class="profile__group">
          <span class="profile__value"><?php echo $btn;?></span>
          <span class="profile__param"><span class="glyphicon glyphicon-bitcoin">&nbsp;</span>Batch</span>
        </div>          
        
		  <div class="profile__group1" >
          <span class="profile__value" style="font-size: 17px;text-transform: capitalize"><?php echo $town;?></span>
          <span class="profile__param"><span class="glyphicon glyphicon-home">&nbsp;</span>Town</span>
        </div>          
